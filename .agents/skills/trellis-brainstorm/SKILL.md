...
```bash
TASK_DIR=$(C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/task.py create "<short task title>" --slug <slug>)
```
