...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform codex
```
