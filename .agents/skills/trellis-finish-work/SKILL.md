...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py --mode record
```
...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/task.py archive <task-name>
```
...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/add_session.py \
  --title "Session Title" \
  --commit "hash1,hash2" \
