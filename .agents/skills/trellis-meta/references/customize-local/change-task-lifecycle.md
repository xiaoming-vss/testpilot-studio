...
hooks:
  after_create:
    - "C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/task.py current --source`.
