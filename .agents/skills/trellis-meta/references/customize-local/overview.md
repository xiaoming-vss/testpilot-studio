...
2. **Confirm the current active task**: run `C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/task.py current --source`.
