...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py
```
...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py --mode phase
```
...
```bash
C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py --mode packages
...
- **Active task status `in_progress`** → Phase 2 step 2.1. Load the step detail:
  ```bash
  C:\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe ./.trellis/scripts/get_context.py --mode phase --step 2.1 --platform codex
  ```
