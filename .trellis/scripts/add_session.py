...
Usage:
    C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe add_session.py --title "Title" --commit "hash" --summary "Summary" [--package cli]
    C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe add_session.py --title "Title" --branch "feat/my-branch"

    # Pipe detailed content via stdin (use --stdin to opt in):
    cat << 'EOF' | C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe add_session.py --stdin --title "Title" --summary "Summary"
