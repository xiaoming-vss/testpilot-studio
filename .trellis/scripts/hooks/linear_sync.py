...
Usage (called automatically by task.py hooks):
    C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/linear_sync.py create
    C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/linear_sync.py start
    C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json C:\\Users\limin\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe .trellis/scripts/hooks/linear_sync.py sync
